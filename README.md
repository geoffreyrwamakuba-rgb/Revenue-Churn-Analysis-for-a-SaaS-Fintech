...
1. Understanding Expansion & Contraction Drivers
2. Predicting Churn Before Revenue Loss
3. Forecasting Revenue Accurately
...
1.	MRR Movements - Using LAG() to compare monthly MRR per account:
a.	New MRR — first-ever month of revenue
b.	Expansion — seats or plans increased
c.	Contraction — reductions in seats or usage
d.	Churn — lost revenue after churn date
2.	Quarterly Cohort Table - Cohorts grouped by signup quarter with:
a.	retained flags
b.	quarter-by-quarter activity
3.	Net Revenue Retention (NRR) 
a.	Calculated using existing customers only
4.	Churn Rate - Customer churn rate based on previous-month active accounts.
5.	Expansion MRR %
